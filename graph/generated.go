...
func (ec *executionContext) field_Mutation_createCategory_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewCategory2githubᚗcomᚋdevfullcycleᚋ13ᚑGraphQLᚋgraphᚋmodelᚐNewCategory(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_createCourse_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNNewCourse2githubᚗcomᚋdevfullcycleᚋ13ᚑGraphQLᚋgraphᚋmodelᚐNewCourse(ctx, tmp)
	}
